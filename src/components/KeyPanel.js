              ...
              >
                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-md bg-white p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  <div className="py-2 flex flex-col">
                    <label className="text-black text-sm py-2">
                      OpenAI API Key (
                      <Link
                    ...
                    <div className="relative w-full flex px-3 py-2 bg-transparent rounded-md ring-2 ring-[#343434] focus-within:ring-purple-400 ease-linear transition">
                      <input
                        ...
                        className=" text-neutral-700 text-sm bg-transparent focus:outline-none w-full pr-2"
                        id="collectionName"
                        name="collectionName"
                        value={apiKey}
                      ...
                      <svg
                        ...
                        className="w-6 h-6 text-neutral-600 hover:text-black ease-linear transition cursor-pointer"
                      >
                        {showKey ? (
                          <>
                            <path
                  ...
                  <div className="flex justify-end gap-2 pt-4">
                    <button
                      type="button"
                      className="inline-flex justify-center rounded-md bg-purple-500 disabled:brightness-90 disabled:hover:bg-purple-500 disabled:cursor-not-allowed px-4 py-2 text-sm font-medium text-white hover:bg-purple-600 transition ease-linear focus:outline-none"
                      disabled={
                        apiKey.length === 0 &&
